...
double h_md, int Nmd, int N, int *n_outbox_md, int *n_outbox_mpcd, int mass, int mass_fluid, double *L, int grid_size, int shared_mem_size, int shared_mem_size_, int blockSize_, int grid_size_, double *md_dt_x, double *md_dt_y, double *md_dt_z, double *md_dt_min ,
...
__host__ void Active_noslip_MD_streaming(double *d_mdX, double *d_mdY, double *d_mdZ, double *d_x, double *d_y, double *d_z,
    ...
    double h_md, int Nmd, int m_md, int N, int mass, int mass_fluid, double *d_L , double ux, int grid_size, int shared_mem_size, int shared_mem_size_, int blockSize_, int grid_size_, int delta, double real_time, double *gama_T, int *random_array, unsigned int seed, int topology, int *flag_array, double u_scale,
