...
__host__ void Active_noslip_MPCD_streaming(double* d_x, double* d_y , double* d_z, double* d_vx , double* d_vy, double* d_vz, double h_mpcd, int N, int grid_size, double *fa_x, double *fa_y, double *fa_z, 
